...
public class NumberPicker extends LinearLayout {
	...
	/** Add by wanzhiyuan : 修改三星等部分手机预告选择时间出现黑线问题  **/
	private static final float TOP_AND_BOTTOM_FADING_EDGE_STRENGTH = 0.0f;//顶部和底部边缘强度
...
//			System.out.println("Set Invisible by changeValueByOne");
	...
	class SetSelectionCommand implements Runnable {
		...
		public void run() {
			//Add by XingRongJing:避免某些手机setSpan(2,4) ends beyond length 0异常
			int length = mInputText.length();
			if(length>mSelectionStart&&length>mSelectionEnd){
